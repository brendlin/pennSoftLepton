...
#ifndef pennSoftLepton_XSUSYObjDefAlgPlusPlus_H
#define pennSoftLepton_XSUSYObjDefAlgPlusPlus_H
...
namespace PSL
{
  class XSUSYObjDefAlgPlusPlus : public ObjectSelectionBase
  {
  ...
  public:
    ...
    ClassDef(XSUSYObjDefAlgPlusPlus, 1);
  };
  
}
#endif // pennSoftLepton_XSUSYObjDefAlgPlusPlus_H
