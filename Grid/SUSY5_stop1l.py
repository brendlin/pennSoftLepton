...
SUSYTRUTH5NeutrinoTool = DerivationFramework__TruthCollectionMaker(name                   = "SUSYTRUTH5NeutrinoTool",
                                                               NewCollectionName       = "TruthNeutrinos",
                                                               ParticleSelectionString = "(abs(TruthParticle.pdgId) == 12 || abs(TruthParticle.pdgId) == 14 || abs(TruthParticle.pdgId) == 16)")
ToolSvc += SUSYTRUTH5NeutrinoTool
...
SUSY5TruthThinningTool = DerivationFramework__MenuTruthThinning(name                       = "SUSY5TruthThinningTool",
                                                     ...
                                                     WritePartons               = False,
                                                     WriteHadrons               = False,
                                                     WriteBHadrons              = False, #True
                                                     WriteGeant                 = False,
                                                     GeantPhotonPtThresh        = 20000,
                                                     WriteTauHad                = False, #True
                                                     PartonPtThresh             = -1.0,
                                                     WriteBSM                   = False, #True
                                                     WriteBosons                = False, #True
						     WriteBosonProducts = False, #True
                                                     WriteBSMProducts           = False, #True
                                                     WriteTopAndDecays          = False, #True
                                                     WriteEverything            = False,
                                                     WriteAllLeptons            = False,
                                                     WriteLeptonsNotFromHadrons = False,
                                                     WriteStatus3               = False,
                                                     WriteFirstN                = -1,
								PreserveAncestors = False, #True
...
electronsRequirements = '(DFCommonElectrons_pt > 7.*GeV) && (abs(DFCommonElectrons_eta) < 2.6) && ((ElectronCollection.Loose) || (ElectronCollection.DFCommonElectronsLHLoose))'
#jetsRequirements = '(abs(AntiKt4LCTopoJets.pt) >= 25.*GeV)'
jetsRequirements = 'AntiKt4LCTopoJets.JetConstitScaleMomentum_pt - AntiKt4LCTopoJets.ActiveArea4vec_pt * Kt4LCTopoEventShape.Density >= 25.*GeV'
...
# 13 TeV MC
	...
	#expression = objectSelection
	expression = 'count(abs(AntiKt4LCTopoJets.pt) >= 10.*GeV)>-1'
...
DerivationFrameworkJob += CfgMgr.DerivationFramework__DerivationKernel("SUSY5Kernel",
									...
									ThinningTools = thinningTools,
								       AugmentationTools = [SUSYTRUTH5MuonTool,SUSYTRUTH5ElectronTool,SUSYTRUTH5PhotonTool,SUSYTRUTH5TauTool,
											    SUSYTRUTH5TopTool,SUSYTRUTH5BosonTool,SUSYTRUTH5SUSYTool, SUSYTRUTH5NeutrinoTool])
...
SUSY5Stream.AddItem( "xAOD::TruthParticleContainer_v1#TruthPhotons*")
SUSY5Stream.AddItem( "xAOD::TruthParticleContainer_v1#TruthElectrons*")
SUSY5Stream.AddItem( "xAOD::TruthParticleContainer_v1#TruthMuons*")
SUSY5Stream.AddItem( "xAOD::TruthParticleContainer_v1#TruthTaus*")
SUSY5Stream.AddItem( "xAOD::TruthParticleContainer_v1#TruthTop*")
SUSY5Stream.AddItem( "xAOD::TruthParticleContainer_v1#TruthBoson*")
SUSY5Stream.AddItem( "xAOD::TruthParticleContainer_v1#TruthSUSY*")
SUSY5Stream.AddItem( "xAOD::TruthParticleContainer_v1#TruthNeutrino*")

SUSY5Stream.AddItem( "xAOD::TruthParticleAuxContainer_v1#TruthPhotons*")
SUSY5Stream.AddItem( "xAOD::TruthParticleAuxContainer_v1#TruthElectrons*")
SUSY5Stream.AddItem( "xAOD::TruthParticleAuxContainer_v1#TruthMuons*")
SUSY5Stream.AddItem( "xAOD::TruthParticleAuxContainer_v1#TruthTaus*")
SUSY5Stream.AddItem( "xAOD::TruthParticleAuxContainer_v1#TruthTop*")
SUSY5Stream.AddItem( "xAOD::TruthParticleAuxContainer_v1#TruthBoson*")
SUSY5Stream.AddItem( "xAOD::TruthParticleAuxContainer_v1#TruthSUSY*")
SUSY5Stream.AddItem( "xAOD::TruthParticleAuxContainer_v1#TruthNeutrino*")
